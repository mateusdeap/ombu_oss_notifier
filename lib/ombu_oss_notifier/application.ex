defmodule OmbuOssNotifier.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: OmbuOssNotifier.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    OmbuOssNotifierWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
